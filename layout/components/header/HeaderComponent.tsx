...
const HeaderComponent: React.FC<Props> = (props) => {
      ...
      newConnection
        ...
        .then(() => {
          newConnection.on("newNotify", async (data: any) => {
            ...
            console.log("isFree in socket: ", isFree);
            console.log("dataEmergencyListInQueue in socket: ", dataEmergencyListInQueue);
            console.log("havingNotiEmergency in socket: ", havingNotiEmergency);
  ...
  useEffect(() => {
    if (isFree && dataEmergencyListInQueue.length > 0 && !havingNotiEmergency) {
      ...
      console.log("isFree in noti popup: ", isFree);
      console.log("havingNotiEmergency in noti popup: ", havingNotiEmergency);
      console.log("dataEmergencyListInQueue in noti popup: ", dataEmergencyListInQueue);
